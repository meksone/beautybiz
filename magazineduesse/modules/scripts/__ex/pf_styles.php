...
function _pincuter_base_stylesheets() {
	...
	wp_enqueue_style('pincuter-initial-style', get_stylesheet_directory_uri() . '/assets/css/initial.css?v='.$time, false, null, 'all' );
	wp_enqueue_style('pincuter-container-style', get_stylesheet_directory_uri() . '/assets/css/container.css?v='.$time, false, null, 'all' );
	wp_enqueue_style('pincuter-mod-bootstrap-style', get_stylesheet_directory_uri() . '/assets/css/mod.bootstrap.css?v='.$time, false, null, 'all' );
	wp_enqueue_style('pincuter-libraries-utilities-style', get_stylesheet_directory_uri() . '/assets/css/libraries-utilities.css?v='.$time, false, null, 'all' );
		
	wp_enqueue_style('pincuter-fontawesome-style', get_stylesheet_directory_uri() . '/assets/css/fontawesome.css?v='.$time, false, null, 'all' );
	wp_enqueue_style('pincuter-fancybox-style', get_stylesheet_directory_uri() . '/assets/css/fancybox.css?v='.$time, false, null, 'all' );
	wp_enqueue_style('pincuter-glyphicons-style', get_stylesheet_directory_uri() . '/assets/css/glyphicons.css?v='.$time, false, null, 'all' );
	wp_enqueue_style('pincuter-slick-style', get_stylesheet_directory_uri() . '/assets/css/slick.css?v='.$time, false, null, 'all' );
...
function _pincuter_admin_styles() {
	...
	wp_enqueue_style( 'pincuter-admin-theme-style', THEME_URL.'/assets/admin/admin-style.css', false, '1.0.0' ); 
