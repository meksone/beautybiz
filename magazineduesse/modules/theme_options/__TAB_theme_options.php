...
class PNCTR_theme_options_Admin {
	...
	function add_options_page_metabox() {
		...
		$cmb_pincuter_theme_options_box_options = array(
			'id'       => $this->metabox_id,
		...
		$cmb_pincuter_theme_options = new_cmb2_box( $cmb_pincuter_theme_options_box_options );

		$cmb_pincuter_theme_options_tabs_setting = array(
			'config' => $cmb_pincuter_theme_options_box_options,
			'layout' => 'vertical', // Default : horizontal
			'tabs'   => array()
		);

		/*
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_header',
			'title'  => __( 'Hero', CURRENT_DOMAIN ),
			'fields' => array(
		...
		*/
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_header',
			'title'  => __( 'Header', CURRENT_DOMAIN ),
			'fields' => array(
				array(
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_social',
			'title'  => __( 'Social', CURRENT_DOMAIN ),
			'fields' => array(
				array(
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_default',
			'title'  => __( 'Default', CURRENT_DOMAIN ),
			'fields' => array(
				array(
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_footer',
			'title'  => __( 'Footer', CURRENT_DOMAIN ),
			'fields' => array(
				array(
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_azienda',
			'title'  => __( 'Azienda', CURRENT_DOMAIN ),
			'fields' => array(
				array(
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_apps',
			'title'  => __( 'Apps', CURRENT_DOMAIN ),
			'fields' => array(
				array(
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_abbonamento',
			'title'  => __( 'Abbonamento', CURRENT_DOMAIN ),
			'fields' => array(
				array(
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_rivista',
			'title'  => __( 'Rivista Box Office', CURRENT_DOMAIN ),
			'fields' => array(
				array(
		...
		$cmb_pincuter_theme_options_tabs_setting['tabs'][] = array(
			'id'     => 'theme_options_setting_tab_rivista_ic',
			'title'  => __( 'Rivista Italian Cinema', CURRENT_DOMAIN ),
			'fields' => array(
				array(
					'name'       => __( 'Rivista Anno di Nascita LABEL', CURRENT_DOMAIN ),
		...
		$cmb_pincuter_theme_options->add_field( array(
			'id'   => 'theme_options_settings_tabs',
			'type' => 'tabs',
			'tabs' => $cmb_pincuter_theme_options_tabs_setting
		) );
