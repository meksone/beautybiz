...
class Assets {
	...
	public function admin_assets() {
		...
		wp_enqueue_style( 'dtheme-cmb2-tabs', get_stylesheet_directory_uri().'/libraries/metabox/extensions/tabs/assets/css/cmb2-tabs.css', array(), '1.0.1' );

		// Js
		wp_enqueue_script( 'jquery-ui' );
		/*wp_enqueue_script( 'dtheme-cmb2-tabs', plugin_dir_url( __DIR__ ) . '/assets/js/cmb2-tabs.js', array( 'jquery-ui-tabs' ) );*/
        wp_enqueue_script( 'dtheme-cmb2-tabs', get_stylesheet_directory_uri().'/libraries/metabox/extensions/tabs/assets/js/cmb2-tabs.js', array( 'jquery-ui-tabs' ) );
	}
