...
echo '
    <style>
    ul.wp_get_archives li:first-child {
        display: none;
    }
    </style>
';
...
?>
    ...
    <div id="category_loop_wrap" class="category_loop__latest category_template_standard" data-getdate="<?php echo get_the_date('Y'); ?>">
        <div class="row">
