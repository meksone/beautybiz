		...
		<div class="col-md-12 col-xs-12">
			...
			<ul class="share-buttons unstyled clearfix">
				...
				<li class="whatsapp">
					...
					if( wp_is_mobile() ){
						echo '<a href="whatsapp://send?text='.$title.' '.$permalink.'" target="_blank">';
					} else {
						echo '<a href="https://web.whatsapp.com/send?text='.$title.' '.$permalink.'" target="_blank">';
					}
					
					/*echo '<a href="https://api.whatsapp.com/send?text='.$title.' '.$permalink.'" target="_blank">';*/
					?>
