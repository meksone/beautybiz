...
echo '<figure class="thumb_normal mb-0" data-image-id="'.$category_thumb_image_id.'">';
	echo '<a href="'.get_permalink($category_post_id).'" title="'.$category_post_title.'">';
        echo wp_get_attachment_image( $category_thumb_image_id, 'pnctr_image_thumb_vertical_special', false, array( 'class' => 'img-fluid' ) );
	echo '</a>';
echo '</figure>';
