...
<section id="frontpage_approfondimenti_v1" class="frontpage_approfondimenti frontpage_loop">
    ...
    <div class="grid">
        <div class="g-col-12 g-col-md-7 g-col-item g-col-item-big">
            <?php 
                    ...
                    <div class="col_item post_item">
                        <article <?php post_class(); ?>>
                            <div class="post_thumb" data-file-thumb-src="_home_thumb_approfondimenti_big">
                                <?php 
                                include(get_stylesheet_directory() . '/templates/home/home_thumb/_home_thumb_approfondimenti_v1_big.php');
                                ?>
                            </div>
                            <div class="post_desc">
        ...
        <div class="g-col-12 g-col-md-5 g-col-item g-col-item-small">
        <?php 
            $approfondimenti_args = array(
                'post_type' => 'post',
                'post_status' => 'publish',
            ...
            if ($approfondimenti_query->have_posts()) :	
                while ($approfondimenti_query->have_posts()) : $approfondimenti_query->the_post();
                    ...
                    <div class="col_item post_item">
                        <article <?php post_class(); ?>>
                            <div class="post_thumb" data-file-thumb-src="_home_thumb_approfondimenti_small">
                                <?php 
                                include(get_stylesheet_directory() . '/templates/home/home_thumb/_home_thumb_approfondimenti_v1_small.php');
                                ?>
                            </div>
                            <div class="post_desc">
                                <div class="post_categories">
                                ...
                                <div class="post_meta">
                                    <div class="post_meta__inner">
                                        <?php 
                                        /*
                                        <div class="post_meta_author"><?php echo esc_html(get_the_author_meta('display_name')); ?></div>
                                        <div class="post_meta_separator">|</div>
                                        */
                                        ?>
                                        <div class="post_meta_date">
                    ...
                    <?php
                    if( $approfondimenti_countel == 1){
                        echo '<div class="hr hr_approfondimenti_small"></div>';
                    }
