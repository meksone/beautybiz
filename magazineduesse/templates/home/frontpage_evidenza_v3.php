...
<div class="frontpage_loop_evidenza_grid">
    <div id="frontpage_primissimo_piano" class="frontpage_primissimo_piano frontpage_loop frontpage_grid_big frontpage_grid_big_count_4">
        <div class="row">
            <?php 
    ...
    <div id="frontpage_primo_piano" class="frontpage_primo_piano frontpage_loop frontpage_grid_small frontpage_grid_small_count_4">
        <div class="row">
            <?php 
            $suppress_filters = get_option('suppress_filters');
            $latest_grid_big_args = array(
