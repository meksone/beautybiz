...
if( !empty($second_featured_image)){
    $second_featured_image_id = get_post_meta($home_post_id, 'em_second_featured_image_id', true);
    $home_thumb_attachment_full = wp_get_attachment_image_src( $second_featured_image_id, 'full' );
    $home_thumb_image_full = $home_thumb_attachment_full[0];
    $home_thumb_image_id = $second_featured_image_id;
	$class_home_thumb = 'edsecond';
} else if( has_post_thumbnail($home_post_id) ){
    $home_thumb_attachment_full = wp_get_attachment_image_src( get_post_thumbnail_id($home_post_id), 'full' );
	$home_thumb_image_full = $home_thumb_attachment_full[0];
    ...
    $home_thumb_image_full = _pincuter_theme_option('theme_options_default_image');
...
$home_thumb_attachment_resize_background = wp_get_attachment_image_src( $home_thumb_image_id, 'full' );
...
$home_thumb_attachment_resize = wp_get_attachment_image_src( $home_thumb_image_id, 'full' );
